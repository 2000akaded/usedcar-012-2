...
<!-- *************************************** -->
    ...
    <div class="container"><h1>แนะนำ</h1></div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <a href="productdetail.php?pid=<?php echo $prd->id; ?>">
                        ...
                        <h3><?php echo $prd->brand; ?></h3>
                            ...
                            <p><strong>Color: <?php echo $prd->color; ?></strong></p>
                            <p><strong>License: <?php echo $prd->license; ?></strong></p>
                            <p><strong>Province: <?php echo $prd->province; ?></strong></p>
                            <p><strong>ModelYear: <?php echo $prd->modelYear; ?></strong></p>
                            <p><strong>Price: <?php echo $prd->price; ?></strong></p>
                            <p><strong>PostedBy: <?php echo $prd->postedBy; ?></strong></p>
